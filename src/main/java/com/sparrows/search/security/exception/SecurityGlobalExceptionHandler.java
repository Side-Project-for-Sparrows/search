...
import static com.sparrows.search.security.exception.SecurityErrorCode.INTERNAL_SERVER;
import static com.sparrows.search.security.exception.SecurityErrorCode.INVALID_REQUEST;

@Slf4j
@RestControllerAdvice("com.sparrows.backend_mono.security")
